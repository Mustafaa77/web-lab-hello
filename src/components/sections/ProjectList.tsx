      ...
      <div className="max-w-6xl mx-auto">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            ...
            <button onClick={() => window.location.reload()} className="text-sm text-red-600 underline mt-2">
              Tekrar dene
            </button>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map(project => (
            <article key={project.id} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  {project.featured && (
                    <span className="bg-yellow-100 text-yellow-800 text-xs px-2 py-0.5 rounded-full">One Cikan</span>
                  )}
                </div>
