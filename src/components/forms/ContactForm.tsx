    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-lg mx-auto" noValidate>
      <div>
        ...
        <input
          ...
          className={`w-full border rounded-lg px-3 py-2 ${errors.name ? "border-red-500" : "border-gray-300 dark:border-gray-700"} dark:bg-gray-800`}
      ...
      <div>
        ...
        <input
          ...
          className={`w-full border rounded-lg px-3 py-2 ${errors.email ? "border-red-500" : "border-gray-300 dark:border-gray-700"} dark:bg-gray-800`}
      ...
      <div>
        ...
        <select
          ...
          className={`w-full border rounded-lg px-3 py-2 ${errors.subject ? "border-red-500" : "border-gray-300 dark:border-gray-700"} dark:bg-gray-800`}
        >
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full border rounded-lg px-3 py-2 resize-y ${errors.message ? "border-red-500" : "border-gray-300 dark:border-gray-700"} dark:bg-gray-800`}
